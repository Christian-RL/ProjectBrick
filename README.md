...
The project is in its foundation stage. Start with the [documentation index](docs/README.md), [roadmap](docs/roadmap.md), [contributor guide](CONTRIBUTING.md), and [agent instructions](AGENTS.md).
